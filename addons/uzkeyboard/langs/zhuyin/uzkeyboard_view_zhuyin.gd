...
const LAYER_BPMF : StringName = &"bpmf"
...
## 目前面板
var _layer_id : StringName = LAYER_BPMF
## 英文大寫
...
func _wire_all () -> void :
	self._wire_layer_btns(self.layer_bpmf, self._on_bpmf_btn)
...
func _on_bpmf_btn (btn : BaseButton) -> void :
...
func _refresh_candidates () -> void :
	self.bar_candi.visible = self._layer_id == LAYER_BPMF \
...
func _show_layer (layer_id : StringName) -> void :
	...
	if self.layer_bpmf != null :
		self.layer_bpmf.visible = (layer_id == LAYER_BPMF)
	if self.layer_en != null :
